...
package com.customer_issues.hrdb.service;
...
import com.customer_issues.hrdb.Department;
import com.customer_issues.hrdb.Employee;
...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    public Department partialUpdate(Integer departmentId, Map<String, Object>departmentPatch) {
        ...
        try {
            ObjectReader departmentReader = this.objectMapper.reader().forType(Department.class).withValueToUpdate(department);
