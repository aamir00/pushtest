...
public interface CountriesService {
     ...
     */
    Countries getById(Integer countriesId);
     ...
     * @return Countries associated with the given countriesId.
     */
    Countries findById(Integer countriesId);
     ...
     */
    List<Countries> findByMultipleIds(List<Integer> countriesIds, boolean orderedReturn);
     ...
     * @throws EntityNotFoundException if no Countries is found with given input.
     */
    Countries partialUpdate(Integer countriesId, Map<String, Object> countriesPatch);
     ...
     */
    Countries delete(Integer countriesId);
    ...
    /*
     * Returns the associated stateses for given Countries id.
     *
     * @param id value of id; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated States instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<States> findAssociatedStateses(Integer id, Pageable pageable);
