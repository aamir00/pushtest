 ...
 * @see States
 */
@Service("Countries1.StatesService")
@Validated
public class StatesServiceImpl implements StatesService {
    ...
    @Autowired
    @Qualifier("Countries1.StatesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service Countries1 for table States to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service Countries1 for table States to {} format", options.getExportType());
