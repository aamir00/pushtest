 ...
 * @see Countries
 */
@Service("Countries1.CountriesService")
@Validated
public class CountriesServiceImpl implements CountriesService {
    ...
    @Lazy
    @Autowired
    @Qualifier("Countries1.StatesService")
    private StatesService statesService;

    @Autowired
    @Qualifier("Countries1.CountriesDao")
    ...
    @Override
    public Countries getById(Integer countriesId) {
    ...
    @Transactional(readOnly = true, value = "Countries1TransactionManager")
    @Override
    public Countries findById(Integer countriesId) {
        LOGGER.debug("Finding Countries by id: {}", countriesId);
        try {
            return this.wmGenericDao.findById(countriesId);
    ...
    @Transactional(readOnly = true, value = "Countries1TransactionManager")
    @Override
    public List<Countries> findByMultipleIds(List<Integer> countriesIds, boolean orderedReturn) {
    ...
    @Transactional(value = "Countries1TransactionManager")
    @Override
    public Countries partialUpdate(Integer countriesId, Map<String, Object>countriesPatch) {
    ...
    @Transactional(value = "Countries1TransactionManager")
    @Override
    public Countries delete(Integer countriesId) {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service Countries1 for table Countries to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service Countries1 for table Countries to {} format", options.getExportType());
    ...
    @Transactional(readOnly = true, value = "Countries1TransactionManager")
    @Override
    public Page<States> findAssociatedStateses(Integer id, Pageable pageable) {
        LOGGER.debug("Fetching all associated stateses");

        StringBuilder queryBuilder = new StringBuilder();
        queryBuilder.append("countries.id = '" + id + "'");

        return statesService.findAll(queryBuilder.toString(), pageable);
    }
