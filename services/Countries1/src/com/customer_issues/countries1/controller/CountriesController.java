...
import com.customer_issues.countries1.Countries;
import com.customer_issues.countries1.States;
import com.customer_issues.countries1.service.CountriesService;
...
public class CountriesController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Countries getCountries(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Countries editCountries(@PathVariable("id") Integer id, @RequestBody Countries countries) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Countries patchCountries(@PathVariable("id") Integer id, @RequestBody @MapTo(Countries.class) Map<String, Object> countriesPatch) {
        LOGGER.debug("Partially updating Countries with id: {}" , id);

        Countries countries = countriesService.partialUpdate(id, countriesPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteCountries(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<States> findAssociatedStateses(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated stateses");
        return countriesService.findAssociatedStateses(id, pageable);
    }
