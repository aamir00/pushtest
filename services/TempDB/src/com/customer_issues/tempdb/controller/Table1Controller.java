...
import com.customer_issues.tempdb.Table1;
import com.customer_issues.tempdb.service.Table1Service;
...
public class Table1Controller {
    ...
    @ApiOperation(value = "Partially updates the Table1 instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table1 patchTable1(@PathVariable("id") Integer id, @RequestBody @MapTo(Table1.class) Map<String, Object> table1Patch) {
        LOGGER.debug("Partially updating Table1 with id: {}" , id);

        Table1 table1 = table1Service.partialUpdate(id, table1Patch);
        LOGGER.debug("Table1 details after partial update: {}" , table1);
